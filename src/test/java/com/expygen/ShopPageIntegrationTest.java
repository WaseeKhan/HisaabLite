...
class ShopPageIntegrationTest {
    ...
    void ownerCanLoadBillingPage() throws Exception {
        mockMvc.perform(get("/sales/new"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Patient / Customer")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Medicine Search Desk")));
    }
    ...
    void ownerCanLoadDashboardWithBatchVisibilityPanels() throws Exception {
        mockMvc.perform(get("/dashboard"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Near Expiry Watch")));
    }
    ...
    void ownerCanLoadPurchasesPage() throws Exception {
        mockMvc.perform(get("/purchases"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Run inward, batch control, and purchase review")));
    }
