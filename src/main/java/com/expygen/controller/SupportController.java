...
public class SupportController {
    ...
    public String supportPage(Model model,
        ...
        long totalTickets = shop != null ? supportTicketRepository.countByShop(shop) : 0;
        long openTickets = shop != null ? supportTicketRepository.countByShopAndStatus(shop, TicketStatus.OPEN) : 0;
        long inProgressTickets = shop != null ? supportTicketRepository.countByShopAndStatus(shop, TicketStatus.IN_PROGRESS) : 0;
        long urgentTickets = shop != null ? supportTicketRepository.countByShopAndPriority(shop, TicketPriority.URGENT) : 0;
        boolean canCreateTicket = user != null && user.getRole() == Role.OWNER;
        ...
        model.addAttribute("canCreateTicket", canCreateTicket);
