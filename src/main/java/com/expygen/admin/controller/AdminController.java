...
import com.expygen.admin.dto.ShopDTO;
import com.expygen.admin.dto.SubscriptionPlanDTO;
        ...
        try {
            ...
            if (user.getId() == null) {
                ...
                if (user.getPassword() == null || user.getPassword().isEmpty()) {
                    user.setPassword(passwordEncoder.encode("expygen@123"));
                } else {
            ...
            if (ownerName != null && !ownerName.trim().isEmpty() &&
                ...
                if (!adminUserRepo.existsByUsername(ownerEmail) &&
                    ...
                    User owner = User.builder()
                            ...
                            .username(ownerEmail)
                            .phone(ownerPhone)
                            .password(passwordEncoder.encode("expygen@123")) // Default password
                            .role(Role.OWNER)
                            .shop(savedShop)
                            .active(true)
                            .approved(true)
