...
public class PdfService {
    ...
    private void addPremiumHeader(Document document, Sale sale) {
        ...
        try {
            ...
            Paragraph fallback = new Paragraph("HL")
                    .setFontSize(14)
                    .setBold();
    ...
    private void addPremiumItemsTable(Document document, Sale sale) {
        ...
        for (SaleItem item : items) {
            ...
            double price = item.getProduct().getPrice() != null ? item.getProduct().getPrice().doubleValue() : 0;
            ...
            table.addCell(createCell(item.getProduct().getName() != null ? item.getProduct().getName() : "Unknown",
                    7, TextAlignment.LEFT, rowColor));
    ...
    private void addPremiumFooter(Document document, Sale sale) {
        ...
        Paragraph footer = new Paragraph(
                "This invoice was generated by HisaabLite • Smart Retail Billing")
                .setFontSize(7)
                .setFontColor(TEXT_LIGHT)
                .setTextAlignment(TextAlignment.CENTER)
                .setMarginTop(5);
